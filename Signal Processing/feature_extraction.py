...
def fe_parallel(combo):
    ...
    # base_path = "F:\\Dropbox (GaTech)\\ML\\data\\sensor_fusion\\Sorted Data OpenSim test\\"
    # norm_path = "F:\\Dropbox (GaTech)\\ML\\data\\sensor_fusion\\norm_matrix_test\\AB"+str(subject)+"_normOS.csv"
    ...
    if path.exists(data_path) == 1:
        ...
        # save_path_dir = "F:\\Dropbox (GaTech)\\ML\\data\\sensor_fusion\\opensim feature data test\\"
